...
pkg install -y x11-repo tur-repo >> /dev/null 2>&1 && pkg install -y proot proot-distro termux-x11-nightly openbox xfce4-terminal xfce4-appfinder xfce4-screenshooter xfce4-power-manager xfce4-notifyd xfce4-taskmanager xfce4-goodies xfce4-panel xcompmgr pcmanfm cairo-dock-core wget zip unzip gedit firefox dbus gimp blender >> /dev/null 2>&1
clear
