...
pkg install -y x11-repo && pkg install -y termux-x11-nightly openbox xfce4-panel xcompmgr pcmanfm nitrogen cairo-dock-core wget zip unzip gedit firefox dbus
