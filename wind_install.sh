...
pkg install -y x11-repo >> /dev/null 2>&1 && pkg install -y termux-x11-nightly openbox xfce4-terminal xfce4-appfinder xfce4-screenshooter xfce4-power-manager xfce4-notifyd xfce4-taskmanager xfce4-goodies xfce4-panel xcompmgr pcmanfm cairo-dock-core wget zip unzip gedit firefox dbus gimp >> /dev/null 2>&1
clear
